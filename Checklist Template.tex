...
\usepackage{multirow}
\usepackage{csquotes}
\usepackage{booktabs} % MS (added by Toine Bogers)
\usepackage{adjustbox} % MS (added by Toine Bogers)

% Adjust by replacing the title with your own conference or journal name. 
...
% BEGIN Formatting Checklist Yes, No, n/a, TODO (added by Joeran)
...
% END Formatting Checklist Yes, No, n/a, TODO (added by Joeran)
